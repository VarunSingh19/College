...
#         stock_price_element = soup.find('div', {'class': 'D(ib) Mend(20px)'}).find('fin-streamer')
...
# print("All stock data has been saved to stock_data.txt")
...
with open('stock_data.txt', 'w') as file:
    # Write all stock information to the file
    for stock_info in stock_data:
        file.write(stock_info + '\n')

# Extract stock prices from the information
